...
/**
 * Test restriction addition.
 * 
 * @author mpermar
 *
 */
public class AddRestrictionTest extends AbstractRepositoryTest {
	...
	public void testAddRestriction() {
		...
		try {
			...
			userProperties.addProperty(UserProperties.USER_ADD_RESTRICTION,repository.getRoot().getId());
